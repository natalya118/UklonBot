...
{
    //[Serializable]
    //public class AddressDialog : IDialog<TaxiLocations>
    //{
    ...
    //        //Location location = uas.GetPlaceLocation(_street, _number);
    //        if (location != null)
    //            await context.PostAsync("Street " + location.AddressName + " , " + location.HouseNumber);
    //        _from = location;
    //        context.Call(
