...
namespace UklonBot.Models.BotSide.OrderTaxi
{
    ...
    public class ChangeCity
    {
        ...
        //public static IForm<ChangeCity> BuildLocalizedForm()

       // {

            // CultureInfo culture = "ru";

            //    IForm<ChangeCity> form;
    ...
    public static IForm<ChangeCity> BuildForm()
        {
            return new FormBuilder<ChangeCity>()
                //.Prompter()
                //.Confirm( new PromptAttribute($"Total for your sandwich is is that ok?")
                //)
