...
//        public string CreateOrder(TaxiLocations locations, string providerId, IDialogContext context)
//        {
...
//            request.Headers.Add("Locale", StateHelper.GetUserLanguageCode(context));
...
//        public double CalculateAmmount(Location fromLocation, Location toLocation, IDialogContext context)
//        {
...
//        public Location GetPlaceLocation(string currentDialogPickupStreet, string currentDialogPickupHouse, IDialogContext context)
//        {
...
//        public IEnumerable<string> GetPlaces(string queryPlace, IDialogContext context)
//        {
...
//        public OrderInfo GetOrderState(string dialogOrderId, IDialogContext context)
//        {
...
//        public void CancelOrder(string currentDialogOrderId, IDialogContext context)
//        {
...
//        public string GetRecreatedOrderId(string orderId, IDialogContext context)
//        {
...
//        public bool Authenticate(string phoneNumber, string viberId, IDialogContext context)
//        {
...
//        public bool Register(string phoneNumber, string provider, string providerId, string phoneValidationCode, IDialogContext context)
//        {
...
namespace UklonBot.Helpers.Exact
{
    public class UklonApiService : IUklonApiService
    {
        ...
        public UklonApiService(IUnitOfWork uow, IUserService userService)
        {
            _uow = uow;
        ...
        public string CreateOrder(TaxiLocations locations, string providerId, IDialogContext context)
        {
            ...
            request.Headers.Add("client_id", WebConfigurationManager.AppSettings["UklonClientId"]);
            request.Headers.Add("Locale", StateHelper.GetUserLanguageCode(context));
            request.Headers.Add("City", _userService.GetUserCity(context.Activity.From.Id).ToString());
        ...
        public IEnumerable<string> GetPlaces(string queryPlace, IDialogContext context)
        {
            ...
            request.Headers.Add("client_id", WebConfigurationManager.AppSettings["UklonClientId"]);
            request.Headers.Add("Locale", StateHelper.GetUserLanguageCode(context));
            var r = _userService.GetUserCity(context.Activity.From.Id).ToString();
            request.Headers.Add("City", _userService.GetUserCity(context.Activity.From.Id).ToString());
